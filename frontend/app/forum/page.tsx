...
export default function ForumPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-to-b from-blue-100 to-white min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        {isUserAuthenticated ? (
          <Button asChild className="bg-gradient-to-r from--500 to-blue-700 hover:from-blue-600 hover:to-blue-800">
            <Link href="/forum/create">
              <MessageSquarePlus className="mr-2 h-4 w-4" /> Create New Post
            </Link>
          </Button>
        ) : (
          <Button asChild variant="outline" className="border-blue-300 text-green-700 hover:bg-blue-50">
      ...
      {posts.length === 0 ? (
        <Card className="text-center py-12 border-blue-700 bg-blue-50">
          <CardContent>
