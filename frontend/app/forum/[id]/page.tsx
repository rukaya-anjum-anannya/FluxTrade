...
export default function ForumPostPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-to-b from-yellow-700 to-white min-h-screen">
      <Button variant="outline" className="mb-6 border-blue-300 text-blue-700 hover:bg-blue-100" asChild>
        <Link href="/forum">
          <ArrowLeft className="mr-2 h-4 w-4 text-blue-700" /> Back to Forum
        </Link>
      </Button>
